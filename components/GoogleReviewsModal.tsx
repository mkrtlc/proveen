...
const GoogleReviewsModal: React.FC<GoogleReviewsModalProps> = ({ isOpen, onClose }) => {
    ...
    const handleScrape = async () => {
        ...
        try {
            ...
            console.error(err);
            setError(err.message || 'Failed to fetch reviews. Please check the URL or try again later.');
        } finally {
            setLoading(false);
        }
    };
            ...
            <div className="bg-white rounded-2xl w-full max-w-2xl max-h-[80vh] flex flex-col shadow-2xl overflow-hidden">
                        ...
                        <div className="flex flex-col gap-4">
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full h-11 px-4 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none"
                                >
                ...
                {step === 'input' && (
                    <div className="p-4 bg-gray-50 border-t border-gray-100 text-center text-xs text-gray-400">
                        Powered by public proxy. Not affiliated with Google.
                    </div>
                )}
            </div>
        </div>
